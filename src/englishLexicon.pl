 ...
 */
lexEntry(ivtbar,[symbol:knowledge,syntax:[know],inf:inf,num:sg,type:assert]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[knows],inf:fin,num:sg,type:assert]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[know],inf:fin,num:pl,type:assert]).

lexEntry(ivtbar,[symbol:knowledge,syntax:[believe],inf:inf,num:sg,type:stipul]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[believes],inf:fin,num:sg,type:stipul]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[believe],inf:fin,num:pl,type:stipul]).

lexEntry(ivtbar,[symbol:knowledge,syntax:[think],inf:inf,num:sg,type:stipul]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[thinks],inf:fin,num:sg,type:stipul]).
lexEntry(ivtbar,[symbol:knowledge,syntax:[think],inf:fin,num:pl,type:stipul]).
