...
\usepackage{amssymb,bbm,qtree,graphicx,natbib,aleks,linguex}
...
\setromanfont [Ligatures={Common,Rare}]{Gentium}
...
\Disc, the discourse so far and $φ$ a new input token (fully parsed
sentence), then consistency means $\Disc → \phi$ holds and informativity
means $\Disc \nvDash$ φ.}
